...
export default function Nav({ show }) {
  ...
  const activeLink = inactiveLink + " bg-zinc-200 text-black rounded-sm";
  ...
  return (
    <aside
      className={
        ...
        " top-0 text-gray-500 p-4 fixed w-full bg-zinc-100 h-full md:static md:w-auto transition-all"
      }
    >
